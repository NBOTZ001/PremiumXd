...
BOT_TOKEN = environ.get('BOT_TOKEN', "6751450675:AAG-aY9P_6yK0TiFBWWA93cA_QLsNomfYyA")    # Bot token from @BotFather
# ============================
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6029347235').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001664051691').split()]  # Channel id for auto indexing (make sure bot is admin)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001849404517'))  # Premium logs channel id
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://www.upilinks.in/payment-link/upi1650800850')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'sahidnawab@axl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sahidnawab650:sahidnawab650@cluster0.djrwcss.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://nawab_me:nawab_me@cluster0.hbastbj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
SHORTENER_API = environ.get("SHORTENER_API", "bdf6b9c35ba62b54c07402701cff71a1bd425f2a") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "instantlinks.co") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "bdf6b9c35ba62b54c07402701cff71a1bd425f2a")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "instantlinks.co")
SHORTENER_API3 = environ.get("SHORTENER_API3", "bdf6b9c35ba62b54c07402701cff71a1bd425f2a")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/nawab_me3') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/nawab_me') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/nawabbotupdate') # Update channel link for the bot
